...
----------------------------------------------------------------------------
  ...
  Oktopus is  designed for  the  Palm  Computing  Platform.  'oktopus.prc' 
  ...
  Oktopus can be installed and executed from flash memory! 

        http://www.ardiri.com/index.cfm?redir=palm&cat=oktopus
  ...
  the boat to the treasure chest and collect as much gold as possible. You
  may configure the key and sound volume in the configuration screen.  You 
  get  to this  by selecting the  menu item 'Config'  in  the 'Game' menu.  
  Consult your handheld device manual for instructions of selecting a menu 
  item. When a game is active, you may tap the speaker icon at  the bottom 
  left of the screen to  get to the configuration screen.  It is  possible 
  to pause the  current  game in progress by tapping the paw icon.

  REGISTRATION:
  =============
  
  Oktopus  is shareware,  the  demonstration  version  does not  allow the 
  player to generate high score codes or  the ability to collect more than
  50 gold coins. To access these features,  a device identification number 
  ...
  at the following web address:
   ...
   http://www.ardiri.com/index.cfm?redir=palm&cat=oktopus&subcat=survey
